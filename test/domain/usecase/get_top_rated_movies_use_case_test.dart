...
void main() {
  ...
  setUp(() {
    ...
    mockMovieRepository = MockMovieRepository();
    useCaseWithParams = GetTopRatedMoviesUseCase(mockMovieRepository);
  });

  test('should retrieve top rated movies from movie repository', () async {
    final int page = 1;
    ...
    verify(mockMovieRepository.getMovies(MovieCategory.TOP_RATED, page));
